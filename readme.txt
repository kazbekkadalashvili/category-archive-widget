...
1. From the Category Archive widget control, you can set the widget's title, category, whether to display the archive as lines or as an unordered list or as a dropdown, whether to group by month or year and whether to show post counts.
